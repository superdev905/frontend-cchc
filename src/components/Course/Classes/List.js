...
import { AssistanceDialog, AttendanceViewDialog } from '../Attendance'
...
const ClassesTab = () => {
  ...
  const { open: openViewAttendance, toggleOpen: toggleOpenViewAttendance } =
    useToggle()
